try {
  ...
  const obj = {
    ...
    log: [],
    updateState: function (num, mod) { // 5 mistakes // states were missing
    ...
    handler: function (event) { // 2 mistakes
      // debugger;
      const form = event.target.form; // target was missing
    ...
    view: function (id) { // 2 mistakes
      ...
      outputEl.style.marginLeft = '5%'; // style must be added
      ...
      container.appendChild(formEl); // formEl should be appended
